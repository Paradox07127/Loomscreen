...
public enum MonitoringStartPolicy {
    /// Delay before the first sample lands on MainActor so the dashboard
    /// view's initial layout completes before observable property writes
    /// cascade through SwiftUI.
