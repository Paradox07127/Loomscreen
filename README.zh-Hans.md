...
| **Loomscreen Pro** | 在 Lite 基础上新增：Metal 着色器、Wallpaper Engine 场景、场景导入，以及 Steam Workshop（在线浏览/下载，需直发版）。 |
...
- Lite 版启动时自动检查一次更新（12 小时限流），并可在 **设置 → About**
  手动检查或跳过版本；Pro 版当前没有内置更新器。
