...
enum GlobalShortcutAction: String, CaseIterable, Codable, Identifiable {
    case togglePlayback
    case nextWallpaper
    case toggleMute
    ...
    typealias RawAction = String

    var rawAction: RawAction { rawValue }
    ...
    static func defaultBinding(for action: GlobalShortcutAction) -> GlobalShortcutBinding? {
        switch action {
        case .togglePlayback:
...
struct GlobalShortcutBinding: Codable, Equatable, Hashable {
    var keyCode: UInt32
