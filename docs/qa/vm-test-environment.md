...
| Host bridge dir        | `/Users/taijial/Xcode/LiveWallpaper/.vm-bridge/` (gitignored)         |
| Guest bridge mount     | `/Users/taijial/Desktop/VirtualBuddyShared/.vm-bridge/`               |
| Bridge sub-folders     | `builds/  dsyms/  crashes/  logs/  samples/`                          |
| Wallpaper library (host)  | `/Users/taijial/Documents/Live Wallpapers/` (15 GB, user-owned)    |
| Wallpaper library (guest) | `/Users/taijial/Desktop/VirtualBuddyShared/Live Wallpapers/` **(read-only)** |
...
|---|------------------------------------------------------|----------------------|----------------|----------------------------------------|
| 1 | `/Users/taijial/Xcode/LiveWallpaper/.vm-bridge`      | `vm-bridge`          | **Read & Write** | Build artifacts, crash logs, samples |
| 2 | `/Users/taijial/Documents/Live Wallpapers`           | (uses folder name)   | **Read only**  | User wallpaper library (15 GB)         |

After boot, VirtualBuddyGuest mounts both under
`/Users/taijial/Desktop/VirtualBuddyShared/`:
...
ssh lw-vm-14 '
  APP="/Users/taijial/Desktop/VirtualBuddyShared/.vm-bridge/builds/LiveWallpaper.app"
...
ssh lw-vm-14 '
  ...
  sample $PID 5 -file "/Users/taijial/Desktop/VirtualBuddyShared/.vm-bridge/samples/sample-$(date +%Y%m%d-%H%M%S).txt"
'
...
<plist version="1.0"><dict>
  ...
  <array>
    ...
    <string>cp -n ~/Library/Logs/DiagnosticReports/LiveWallpaper-*.ips
            "/Users/taijial/Desktop/VirtualBuddyShared/.vm-bridge/crashes/"
            2>/dev/null || true</string>
  </array>
  <key>WatchPaths</key>
  <array><string>/Users/taijial/Library/Logs/DiagnosticReports</string></array>
...
```
/Users/taijial/Desktop/VirtualBuddyShared/Live Wallpapers/
```
...
ssh lw-vm-14 'ls -la /Users/taijial/Desktop/VirtualBuddyShared/.vm-bridge/'
...
codesign --force --sign - --entitlements /tmp/dbg.entitlements \
  /Users/taijial/Desktop/VirtualBuddyShared/.vm-bridge/builds/debugserver'

# 3. Per-session: start debugserver in guest, attach lldb from host
ssh lw-vm-14 '/Users/taijial/Desktop/VirtualBuddyShared/.vm-bridge/builds/debugserver \
